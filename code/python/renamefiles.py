#script for renameming SRR files downloaded from the GEO database (search at: https://www.ncbi.nlm.nih.gov/sra/) into a format workable by downstream applications.
#This makes use of a (,) comma seperated .csv file as a dictionary (format: Experiment Title,SSR accession Number\n xxxxxx,SRRxxxxxx)
import os
